...
slt_cmd ="Select Distribution_OrderInfo_ID,ISBN,ARCHIVED,EBOOK,LIST_PRICE,ORDER_STATUS,ORDER_STATUS_DATE, TITLE,DISTRIBUTION_ORDER_INSTORES_ID,DISTRIBUTION_METADATA_ID,ID,ORDER_DATE,CCID,FORMAT, UPDATED_STATUS,CREATED_DATE,UPDATED_DATE from stg_distribution_orderinfo"
...
insrt_cmd = "INSERT INTO DW_Distribution_Order_Info_DIM(Distribution_OrderInfo_ID,ISBN,ARCHIVED,EBOOK,LIST_PRICE,ORDER_STATUS,ORDER_STATUS_DATE, TITLE,DISTRIBUTION_ORDER_INSTORES_ID,DISTRIBUTION_METADATA_ID,CUSTOMER_ID,ORDER_DATE,CCID,FORMAT, UPDATED_STATUS,CREATED_DATE,UPDATED_DATE) "             "VALUES ( %s )" % (placeholders)
# print(insrt_cmd)
